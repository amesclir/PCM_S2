...
Por ahora, construiremos nuestro objeto "corStruct" usando la función corBrowniana.
...
Para averiguarlo, podríamos hacer esto usando la prueba lógica ==; sin embargo, en las computadoras no suele ser una buena idea evitar intentar evaluar la igualdad de los números reales. Esto se debe a que, por razones técnicas, los números reales pueden diferir en el decimoquinto decimal incluso cuando se supone que son idénticos. 
...
```{r}
summary(pic.primate)$coefficients

summary(pgls.primate)$tTable
...
REFERENCIAS EJEMPLOS PRÁCTICOS
Ortiz, P. L., Fernández‐Díaz, P., Pareja, D., Escudero, M., & Arista, M. (2021). Do visual traits honestly signal floral rewards at community level?. Functional Ecology, 35(2), 369-383.